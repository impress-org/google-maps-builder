...
"normal-sortables"==r.attr("id")&&"google_maps_preview_metabox"!==n.attr("id")&&(o="placeholder-"+d++,
//Move em
...
google.maps.event.trigger(r,"resize")}},//end callbacks
...
e.addClass("closed")}/**
		 ...
		 * @since 2.0
		 */
function i(){n.addClass("magnific-builder").height(p),e("#map").height(p),e("#postbox-container-1").outerHeight(p)}var o,n=e("form#post"),s=e(".postbox").not(".cmb-row, .cmb-repeatable-grouping"),r=e("#map"),l='<input name="save" type="submit" class="button button-primary button-large magnific-submit" id="publish" value="Update Map">',d=0,p=e(window).height()-40;e("#map-builder").on("click",function(e){e.preventDefault(),a()}),
//Open by default?
