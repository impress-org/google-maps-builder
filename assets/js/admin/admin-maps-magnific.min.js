 ...
 * @since 2.0
 */
var gmb_data;console.log(gmb_data),function(e){"use strict";e(document).ready(function(){function a(){
...
"undefined"!=typeof e.fn.sortable&&e(".meta-box-sortables").sortable({disabled:!0})})},open:function(){google.maps.event.trigger(window.map,"resize")},resize:function(){e.magnificPopup.instance.isOpen===!0&&t()},close:function(){s.removeClass("mfp-hide"),n.removeClass("mfp-hide"),n.removeClass("magnific-builder"),e("#postbox-container-1").outerHeight(""),
...
items:{src:n,type:"inline"},midClick:!0})}/**
		 ...
		 * @param postbox
		 */
function i(e){"google_maps_preview_metabox"===e.attr("id")?
...
e.addClass("closed")}/**
		 ...
		 * @since 2.0
		 */
function t(){n.addClass("magnific-builder").height(d),e("#map").height(d),e("#postbox-container-1").outerHeight(d)}var o,n=e("form#post"),s=e(".postbox").not(".cmb-row, .cmb-repeatable-grouping"),r=(e("#map"),'<input type="submit" class="button button-primary button-large magnific-submit" id="publish" value=" '+gmb_data.i18n.update_map+'">'),l=0,d=e(window).height()-40;e("#map-builder").on("click",function(e){e.preventDefault(),a()}),
//Open by default?
"true"===gmb_data.modal_default&&a(),
//Submit button
e("body").on("click",".magnific-submit",function(a){e("#publish").trigger("click")})})}(jQuery);