...
//Close button
$(".magnific-builder .button-primary, .gmb-modal-close").on("click",function(){$(this).parents(".white-popup").appendTo(".modal-placeholder").unwrap()})}else $.magnificPopup.open({items:{src:$("#marker-icon-modal"),type:"inline"},midClick:!0})})}/**
