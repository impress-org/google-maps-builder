...
var gmb_data,gmb_upload_marker,trafficLayer=new google.maps.TrafficLayer,transitLayer=new google.maps.TransitLayer,bicycleLayer=new google.maps.BicyclingLayer,placeSearchAutocomplete;!function(e){"use strict";/**
	 ...
	 */
function a(){var a=e(".map-autocomplete-wrap"),n=e("#map-location-autocomplete").get(0),o=new google.maps.places.Autocomplete(n);o.bindTo("bounds",map),google.maps.event.addListener(o,"place_changed",function(){var n=o.getPlace();
// If the place has a geometry, then present it on a map.
//Close modal
return n.geometry?(n.geometry.viewport?map.fitBounds(n.geometry.viewport):(map.setCenter(n.geometry.location),map.setZoom(17)),e(a).find(".mfp-close").trigger("click"),void t(a)):void window.alert("Autocomplete's returned place contains no geometry")}),
...
e("#modal_title").on("blur",function(){e("input#title").val(e(this).val())})}/**
	 ...
	 */
function o(){var a=e(".lat-lng-update-btn"),t=e(".update-lat-lng"),n=map.getCenter();e(".live-latitude").text(n.lat()),e(".live-longitude").text(n.lng()),t.attr("data-lat",n.lat()),e(".lat-lng-change-message").slideDown(),t.attr("data-lng",n.lng()),a.attr("data-lat",n.lat()),a.attr("data-lng",n.lng()),a.removeAttr("disabled"),t.removeAttr("disabled")}/**
	 * Kick it off on Window Load
	 */
e(window).on("load",function(){a(),n(),
...
e("body").on("click",".gmb-magnific-inline",function(a){a.preventDefault();var n="."+e(this).data("target");//target element class name
//Modal in modal?
...
var o=e(n).find(".inner-modal-wrap"),i=e(n).find(".inner-modal-container");
//Not wrapped, wrap it
0==o.length&&0==i.length&&(e(n).addClass("white-popup").wrapInner('<div class="inner-modal-wrap"><div class="inner-modal-container"><div class="inner-modal clearfix"></div></div></div>'),e('<button type="button" class="gmb-modal-close">&times;</button>').prependTo(e(n).find(".inner-modal"))),
...
t(n)}),
//Close button
e(".gmb-modal-close").on("click",function(){t(n)})}else e.magnificPopup.open({callbacks:{beforeOpen:function(){e(n).addClass("white-popup")}},items:{src:e(n),type:"inline"},midClick:!0})})})}(jQuery);