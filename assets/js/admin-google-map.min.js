...
"undefined"!=typeof n&&n.setVisible(!1),$(".drop-marker").removeClass("active").text("Drop a Marker"),//reset drop button
map.setOptions({draggableCursor:null}),//reset cursor
google.maps.event.removeListener(a);//remove map click event
//add marker at clicked location
var n=new Marker({position:e,map:map,icon:gmb_data.default_marker,zIndex:google.maps.Marker.MAX_ZINDEX+1,optimized:!1}),i=get_marker_index();
//add data to fields
$("#gmb_markers_group_"+i+"_title").val("Point "+i),$("#gmb_markers_group_"+i+"_lat").val(t),$("#gmb_markers_group_"+i+"_lng").val(o),get_editable_info_window(i,n),google.maps.event.addListener(n,"click",function(){get_info_window_content(i,n)})}/**
	 * Map Intialize
	 *
...
if(map=new google.maps.Map(e[0],o),places_service=new google.maps.places.PlacesService(map),
...
//EVENTS
var o=google.maps.event.addListener(tentative_location_marker,"mouseover",function(e){add_circle(a)}),n=google.maps.event.addListener(tentative_location_marker,"mouseout",function(e){hover_circle.setVisible(!1)});
//location clicked
google.maps.event.addListener(tentative_location_marker,"click",function(){
//remove event listeners
google.maps.event.removeListener(o),google.maps.event.removeListener(n),
//show circle
...
tentative_location_marker.setVisible(!0),e.setZoom(zoom)}/**
	 ...
	 */
function add_tenative_info_window(e,a){var t={key:gmb_data.api_key,placeId:e};places_service.getDetails(t,function(e,t){if(t==google.maps.places.PlacesServiceStatus.OK){var o=e.geometry.location.lat(),n=e.geometry.location.lng(),i='<p class="place-title">'+e.name+"</p>";i+=add_place_content_to_info_window(e),i+='<div class="infowindow-toolbar clear"><a href="#" class="add-marker" data-title="'+e.name+'" data-place_id="'+e.place_id+'"  data-lat="'+o+'" data-lng="'+n+'">Add to Map</a></div>',i=set_info_window_wrapper(i),//wraps the content in div and returns
info_bubble.setContent(i),//sets the info window content
...
if(o.place_id){var n={key:gmb_data.api_key,placeId:o.place_id};places_service.getDetails(n,function(n,i){i==google.maps.places.PlacesServiceStatus.OK&&(
//place name
t='<p class="place-title">'+o.title+"</p>",t+='<div class="place-description">'+o.desc+"</div>",t+=add_place_content_to_info_window(n),
//toolbar
...
function lat_lng_field_change(e){var a=new google.maps.LatLng($(lat_field).val(),$(lng_field).val());e.panTo(a)}/**
	 ...
	 * @param pagination
	 */
function places_search_callback(e,a,t){var o,n=0;
//setup new markers
if(a==google.maps.places.PlacesServiceStatus.OK){
//place new markers
for(n=0;o=e[n];n++)create_search_result_marker(e[n]);
...
e.prop("checked")||$("#gmb_show_places2").prop("checked",!0),e.on("change",function(){$(".cmb2-id-gmb-search-radius").toggle(),$(".cmb2-id-gmb-places-search-multicheckbox").toggle(),"no"===$(this).val()?clear_search_markers():perform_places_search()})}/**
	 * Set Zoom Control
	 */
...
$(".toggle-repeater-groups").on("click",function(e){e.preventDefault(),$("#gmb_markers_group_repeat .cmb-repeatable-grouping").toggleClass("closed")})});//End Window Load
