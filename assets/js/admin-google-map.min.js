...
$(".gmb-magnific-inline").on("click",function(){if($.magnificPopup.instance.isOpen===!0){
...
$(this).appendTo(".modal-placeholder").unwrap()})}else $.magnificPopup.open({items:{src:$("#marker-icon-modal"),type:"inline"},midClick:!0})})}/**
