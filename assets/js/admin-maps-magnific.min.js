...
//Add save button
0===e(".magnific-submit").length&&e(".magnific-builder #postbox-container-1").append(l),
//Move metaboxes to sidebar and hide other none-GMB metaboxes in Magnific modal
s.each(function(a,t){var n=e(this),s=n.attr("id");
...
"normal-sortables"==l.attr("id")&&"google_maps_preview_metabox"!==n.attr("id")&&(i="placeholder-"+r++,
//Move em
n.before('<div class="placeholder '+i+'"></div>').appendTo("#side-sortables").data("placeholder",i))}else
//hide non GMB metaboxes
e(this).addClass("mfp-hide");
//Disable metabox dragging/sorting
"undefined"!=typeof e.fn.sortable&&e(".meta-box-sortables").sortable({disabled:!0})})},resize:function(){e.magnificPopup.instance.isOpen===!0&&t()},close:function(){s.removeClass("mfp-hide"),n.removeClass("mfp-hide"),n.removeClass("magnific-builder"),e("#postbox-container-1").outerHeight(""),
...
items:{src:n,type:"inline"},midClick:!0})}/**
		 ...
		 * @param postbox
		 */
function o(e){"google_maps_preview_metabox"===e.attr("id")?
//ensure Gmap metabox always is open
e.removeClass("closed"):
//Close all other GMB metaboxes by default
e.addClass("closed")}function t(){n.addClass("magnific-builder").height(d),e("#map").height(d),e("#postbox-container-1").outerHeight(d),console.log("here")}var i,n=e("form#post"),s=e(".postbox").not(".cmb-row, .cmb-repeatable-grouping"),l=(e("#map"),'<input name="save" type="submit" class="button button-primary button-large magnific-submit" id="publish" value="Update">'),r=0,d=e(window).height()-40;e("#map-builder").on("click",function(e){e.preventDefault(),a()}),
//Submit button works
