...
"undefined"!=typeof e.fn.sortable&&e(".meta-box-sortables").sortable({disabled:!0})})},resize:function(){e.magnificPopup.instance.isOpen===!0&&i()},close:function(){s.removeClass("mfp-hide"),n.removeClass("mfp-hide"),n.removeClass("magnific-builder"),e("#postbox-container-1").outerHeight(""),
